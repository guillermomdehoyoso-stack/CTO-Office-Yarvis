...
def link_process_instance_to_work(process_instance_id: UUID, payload: LinkProcessInstanceToMissionWorkRequest, request: Request) -> ProcessInstanceWorkLinkRead:
    principal = _principal(request)
...
def unlink_process_instance_from_work(process_instance_id: UUID, link_id: UUID, payload: UnlinkProcessInstanceFromMissionWorkRequest, request: Request) -> ProcessInstanceWorkLinkRead:
    principal = _principal(request)
